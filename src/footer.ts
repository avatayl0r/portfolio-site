...
function createFooter(email: string, liLink: string, githubLink: string, artstationLink: string, gumroadLink: string) {
    ...
    var footerEmail = createWebLink(
        email,
        "Email");

    var footerLinkedIn = createWebLink(
        liLink,
        "LinkedIn");

    var footerGitHub = createWebLink(
        githubLink,
        "GitHub");

    var footerArtStation = createWebLink(
        artstationLink,
        "ArtStation");

    var footerGumroad = createWebLink(
        gumroadLink,
        "Gumroad");
...
function createWebLink(link: string, text: string) {
...
createFooter(
    "mailto: avataylor2033@gmail.com",
    "https://www.linkedin.com/in/avatayl0r/",
    "https://www.github.com/avatayl0r",
    "https://www.artstation.com/avataylor",
    "https://avatay.gumroad.com/");
