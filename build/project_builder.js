...
createProjectElement("qpi - Quick Project Initialiser Tool", "(Active) August 2023 - Present", "QPI is a simple and efficient command-line utility designed to greatly speed-up the process of setting up projects.<br>This tool aims to save you time and effort by automating the initial project setup, so you can focus on what really matters - writing code.<br>Feel free to download and use it for your own projects!", "./images/qpi.png", "https://github.com/aryntaylor/qpi-tool");
createProjectElement("digiwatch mk. i - Digital Watch", "(Active) August 2023 - Present", "I am creating my first ever combination of hardware (electronics) and software (program using C++). This I decided would be a cheap, easy-to-use, and performant digital watch.<br>As this is my first time combining both hardware and software, I predict this will be an ongoing project for a while, however I really am looking forward to updating people on it's progress, and eventually releasing it.", "./images/watch.jpg", "");
createProjectElement("ggf - Web Browser", "(Active) August 2023 - Present", "I am creating a web browser from scratch. This I thought would be an interesting exercise in both understanding how a web browser works, and simultaneously building a web browser that suits my needs better as a programmer.<br>This is an ongoing project, and is being posted to my GitHub page if you are interested in seeing my progress.", "", "");
createProjectElement("aryntaylor.dev", "(Active) August 2023 - Present", "This is my portfolio site, and my first ever feature complete site built from scratch using JavaScript, NodeJS, ThreeJS, HTML, and CSS.<br>I aim to use this site for showcasing my work, updating and logging my resume, having a somewhat reflective about me section, a blog for blogging my various development projects, and a gallery of my 3D models, texturing, materials, shaders, and more.<br>The site is still early in development, and will be consistently being updated.<br>If you are interested in learning more about this journey, please see the Blogs section to read more!", "./images/blog_cover001.png", "https://www.aryntaylor.dev/blog");
